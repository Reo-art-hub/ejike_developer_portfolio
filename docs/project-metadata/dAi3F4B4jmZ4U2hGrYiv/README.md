# Project metadata (dAi3F4B4jmZ4U2hGrYiv)

Structured JSON here syncs with Firestore subcollections `epics`, `phases`, and `sprints` under `projects/dAi3F4B4jmZ4U2hGrYiv`.
